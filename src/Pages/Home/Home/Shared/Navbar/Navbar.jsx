...
const NavBar = () => {
  ...
  <button className="group relative h-12 w-28 overflow-hidden rounded-lg bg-[#008000]  text-lg shadow ml-0 md:mr-[100px]  mb-4 mb:my-0">
    ...
    <span className="relative text-white group-hover:text-black"><Link to="/duas">Duas</Link></span>
            ...
            <button className="btn mb-4 text-white bg-[#33b249] ml-0 md:ml-[200px]"><Link to="#">Login</Link></button>
        ...
        <div className=" fixed   bg-[#FFFDD0] text-black  shadow-sm font-mono full-width top-0 left-0 right-0 navbar z-10 bg-opacity-30 w-full ">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-slate-100 text-{} rounded-box w-52">
                        {navOptions}
                    </ul>
                </div>
                <div className="flex items-center  ">
 <img src="/src/assets/icon/icon5.png" alt="Icon" className="w-20 h-30 "/> 
      <Link   className="btn btn-ghost normal-case text-xl " to="/">Quran-Hadith</Link>
      </div>
